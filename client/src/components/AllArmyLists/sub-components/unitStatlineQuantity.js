    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <label>quanity: {/** temp will be inline with statline table in markup */}
                <input min={quanityMin} type="number" value={quanity} onChange={(e) => setQuantity(e.target.value)} required/>
                </label>
            </form>
